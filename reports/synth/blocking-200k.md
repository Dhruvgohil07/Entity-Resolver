...
59535 of 181,045 true pairs never became candidates. This
...
4. `Wall spkr Mount - 8885P321 Included Supports`
   `Omnimount Speaker Mount - 30WLBK`
5. `Omnimount Wall spkr Mount - 50WLBK`
   `spkr Mount`
6. `Omnimount Wall Mount - 86JUCS`
   `86JUCS-R Omnimount Wall Speaker`
7. `86JUCS-R Omnimount Wall Speaker`
   `Omnimount Wall spkr Mzount - 86-JUCS Necessary Hardware Included`
8. `Omnimount Wall spkr Mount`
   `Omnimount Wall Speaker Mont`
9. `Omnimount Wall spkr Mount`
   `Omnimount Wall Speaker Mont`
10. `Omnimount Wall - 8149X779 All`
...
- **Not every default blocker ran: `lsh (minhash)` did not.** The union row is the ceiling of the
...
- **The blocker parameters were tuned on Abt-Buy, not on this catalog.** The window,
  ...
  catalog would reach.
- **Which ceiling applies depends on what is being compared.** The 0.6712 above is the
